...
from GayuMusic.utils import help_pannel
from GayuMusic.utils.database import get_lang
from GayuMusic.utils.decorators.language import LanguageStart, languageCB
from GayuMusic.utils.inline.help import help_back_markup, private_help_panel
...
@app.on_message(filters.command(["ghelp"]) & filters.group & ~BANNED_USERS)
@LanguageStart

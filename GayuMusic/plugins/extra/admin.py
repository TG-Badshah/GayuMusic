...
from GayuMusic.helper.admin_check import admin_check, admin_filter
...
button = [
    [
        InlineKeyboardButton(
            text=
            "\x41\x6E\x61\x6E\x44", url="\x20\x68\x74\x74\x70\x73\x3A\x2F\x2F\x74\x2E\x6D\x65\x2F\x4B\x49\x4E\x47\x78\x41\x4E\x41\x4E\x44"
        )
    ]
]
